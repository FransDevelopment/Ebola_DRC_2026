...
Last successful build: **28 May 2026, 16:00:42 (UTC)** — `build/` on `main` at commit [`83b1e95`](https://github.com/INRB-UMIE/Ebola_DRC_2026/commit/83b1e95228a7fdbef383c8922b5bb77951ee94fe) (data snapshot [`83b1e95`](https://github.com/INRB-UMIE/Ebola_DRC_2026/commit/83b1e95), see `build/manifest.json`).
...
|-----|------|---------|----------|
| [`build-2026-05-28-83b1e95`](https://github.com/INRB-UMIE/Ebola_DRC_2026/releases/tag/build-2026-05-28-83b1e95) | 2026-05-28 | No data changes, but adjusting repo to trigger automatic rebuild of the dashboard when new release is created. | [release](https://github.com/INRB-UMIE/Ebola_DRC_2026/releases/tag/build-2026-05-28-83b1e95) |
