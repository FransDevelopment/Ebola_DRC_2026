...
5. Use the same `date` value as the processed row when adding provenance entries. Current processed SitRep CSVs use `DD/MM/YYYY`; a full date-format normalisation should be handled as a separate data-cleanup change.
